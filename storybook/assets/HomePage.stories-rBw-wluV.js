var _a, _b, _c;
import { b as useInView, j as jsxRuntimeExports, L as Link, r as reactExports, n as namedRoutes, C as Canvas, O as OrbitControls, c as useLoader, G as Group, d as Mesh, e as MeshStandardMaterial, P as PointLight, H as HemisphereLight, A as AmbientLight, f as useFrame, g as MeshTransmissionMaterial, D as DoubleSide, h as Color, i as GLTFLoader, S as SpotLight, k as Object3D, R as React, a as Metadata } from "./vendor-oeGY3SKp.js";
import { a as loadProjects } from "./staticData-CwXKAj_M.js";
const ProjectCard = ({
  project
}) => {
  const {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: `/projects/${project.slug}`, className: "project-card__link", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref, className: `project-card ${inView ? "project-card--visible" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "project-card__content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "project-card__title", children: project.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "project-card__eyebrow gradient-animated", style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "project-card__link-text", children: "Read More" })
    ] }),
...
const Success = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "projects-list container--normal", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "projects-list__grid", children: projects.map((project) => /* @__PURE__ */ jsxRuntimeExports.jsx(ProjectCard, { project }, project.id)) }) });
};
...
//# sourceMappingURL=HomePage.stories-rBw-wluV.js.map
